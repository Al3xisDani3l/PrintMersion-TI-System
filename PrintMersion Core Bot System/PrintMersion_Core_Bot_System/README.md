...
- In a terminal, navigate to `PrintMersion_Core_Bot_System`

    ```bash
    # change into project folder
    cd PrintMersion_Core_Bot_System
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `PrintMersion_Core_Bot_System` folder
  - Select `PrintMersion_Core_Bot_System.csproj` file
